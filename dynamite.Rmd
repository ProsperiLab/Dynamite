...
.packages <-  c("remotes", "phytools", "data.tree", "tidytree", "rlist", "familyR", "tidyverse", "ggtree", "parallel", "geiger", "tibble") # May need to incorporate code for familyR (https://rdrr.io/github/emillykkejensen/familyR/src/R/get_children.R) i fno longer supported.

## Do we really need phangorn?

## Needed for branchwise algorithm, depending on what we go with: "growthrates", "drc", "paleotree", "quantmod", "phylodyn"
...
write("Data are now being exported as 'result_data.RDS' and 'result_tree.tree.'")
saveRDS(cluster_stats, "result_data.RDS")
...
write.beast(exported_tree, "result_tree.tree")
